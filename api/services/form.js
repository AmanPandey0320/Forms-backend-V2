...
class FormService {
  ...
  GET_ALL_QUE_SQL = `SELECT aq.id,aq.title,aq.description,aq.order,aq.type,aq.when,aq.active,aq.last_edited,aq.required,aq.marks,aq.fid,aq.attachment,aq.sid FROM akp_question as aq WHERE aq.fid = ? AND aq.active = true ORDER BY aq.order`;
